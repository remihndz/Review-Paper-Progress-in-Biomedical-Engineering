...
\subsubsection*{Haemodynamics in artificial retinal vasculature}
...
\subsubsection*{Effects of extravascular pressure on haemodynamics} %NOTE: this could be one section with the next one (Autoregulation pathways)
...
\subsubsection*{Autoregulation pathways}
...
\subsubsection*{Oxygen transport and spatial models}
...
\subsubsection*{Haemodynamics in the central retinal vessels}
...
\subsubsection*{Choroidal circulation}
...
\subsubsection*{Models of pathological geometries}
...
\subsubsection*{Models of glaucoma and vessel occlusion}
...
\subsubsection*{Models of diabetic retinopathy}
