...
These injections are typically done directly in the vitreous humor of the eye with a needle, though alternative delivery techniques are investigated~\cite{Kim2021}.
...
Furthermore, the model showed that suprachoroidal injection were not suited for delivery of large molecules.
...
Other models have simulated the effect of anti-VEGF therapy on clinically relevant features of neovascular AMD, e.g., visual acuity and macular edema~\cite{Edwards_2020, Hoyle_2017, Mulyukov_2018}.
