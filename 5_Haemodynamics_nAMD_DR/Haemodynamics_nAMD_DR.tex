...
The shear stress is proportional to the viscosity of the blood and \textbf{higher shears may relate to degeneration of the vasculature/changes in gas exchanges... find the right refs}.
However, blood viscosity can only be estimated \textit{ex vivo}.
Those measurements provide a single parameter for the whole circulatory system, despite differences between vascular beds or variations depending on vessel caliber.
Indeed, in narrow vessels, the F\r{a}hr\ae us-Lindqvist effect describes the decrease in viscosity of blood with decreasing vessel diameter, as the red blood cells move to the centre of the vessel, while a layer of plasma forms on the walls of the vessels~\cite{F_hr_us_1931}.
...
An example of a typical empirical law is shown in Figure~\ref{fig:effectiveViscosity}.
\begin{figure}
  \centering
  \includegraphics[width=0.45\linewidth]{EffectiveViscosity-Secomb.eps}
  \caption{Example of empirical effective viscosity law accounting for the F\r{a}hr\ae us-Lindqvist effect and increased vascular resistance in smaller capillaries from the work of Secomb and Pries~\cite{Secomb_2013}.}
