...
However, this framework also constitue a weakness of \textit{in silico} models when the understanding of the system is wrong or incomplete.
In constrast, machine learning models can give accurate predictions of a system's output without requiring \textit{a priori} understanding.
...
These are developped by examination of experimental data.
...
Some of those parameters may be known, either from direct measurements (e.g., IOP in most haemodynamics models in Section~\ref{sec:RetinalHaemodynamicsNAMDDR}) or theoretical formulae (e.g., vitreal diffusion times in the PK model of intravitreal injectios in Section~\ref{sec:Anti-VEGF}).
