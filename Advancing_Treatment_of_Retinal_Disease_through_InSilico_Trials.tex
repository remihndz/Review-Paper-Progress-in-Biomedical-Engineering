...
Interestingly, kinetic parameters can be determined with PK analysis with a lesser degree uncertainty.
...
However, an \textit{in silico} model of an \textit{in vitro} setup of the RPE suggests that spatial arrangement of RPE cells and atrophied tissue play an important role in the production of VEGF, a role that may explain the progression of AMD into its neovascular form~\cite{Baker_2017}.
