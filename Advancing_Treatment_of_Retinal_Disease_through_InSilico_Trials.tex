...
In addition, we present models of the pharmacokinetics (PK) and pharmacodynamics (PD) of anti-VEGF therapy.
...
\begin{tcolorbox}[title=Additional information -- Fluid flow modelling]
  ...
  \item A Newtonian fluid is a one with a constant viscosity for given pressure and temperature, regardless of the amount of shear (the stress arising from the friction of fluid particles) it is subject to.
...
The current understanding of the perfusion of the retina is incomplete.
For instance, the exact organization of the retinal capillary plexi and the mechanisms behind retinal and choroidal blood flow autoregulation remain elusive.
A significant effort has been made in modelling the complex circulatory systems that perfuse the retina in order to address this knowledge gap.
