...
In the centre of the retina is an circular pigmented area called the macula that can be seen on photographs of the retina (Figure~\ref{fig:architecture-eye}).
...
\begin{figure}[t!]
  \centering
  \includegraphics[width=\textwidth]{Slide3}
...
Reversing direction, the now electrochemical information travels from the photoreceptors accross a number of retinal neurons to reach the ganglion cells~\cite{Casper_2019}.
...
%Eyes showing little to no improvement in their condition are referred to as non-responsive.
