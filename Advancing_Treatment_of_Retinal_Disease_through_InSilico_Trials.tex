...
\begin{tcolorbox}[title=Additional information -- Fluid flow modelling]
  ...
  \item As demonstrated by F\r ahraeus and Lindqvist, viscosity decreases with vessel width as red blood cells align into a single file, before increasing sharply as it becomes harder to squeeze red blood cells through smaller vessels (as illustrated in Figure~\ref{fig:effectiveViscosity}\cite{Faahraeus_1931}).
