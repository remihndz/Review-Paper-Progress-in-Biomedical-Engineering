...
% The non-neovascular, or non-neovascular, form of age-related macular degeneration (non-nAMD) is a common condition in individuals over fifty years of age.
...
% In the end-stage of non-nAMD, RPE cells degenerate and form geographic atrophy in the macula~\cite{Jager_2008}.
...
Such degeneration includes an increase in vascular permeability, a loss of the pericytes coating capillary walls and a thickening of the endothelial basement membrane to which endothelial cells are attached~\cite{Medina_2016}.
...
The subsequent release of vascular endothelial growth factor (VEGF) may drive diabetic retinopathy (DR) to its proliferative stage.
...
The neovascular membranes cause further haemorrhages, oedemas and scarring of the tissue.
Scarring and blood toxicity damage the photoreceptors, sometimes permanently, resulting in dramatic loss of sight~\cite{Friedlander_2007,Gupta_2015}.
...
The neovascular form of AMD (nAMD) is characterised by an appearance of macular neovasculature and a much more rapid loss of sight compared to its non-neovascular form. 
% The current understanding of the pathogenesis of nAMD is that, in addition to other age-related changes in the retina, the progressive buildup of materials in Bruch's membrane characteristic of non-nAMD induces hypoxic conditions in the outer retina~\cite{Jager_2008,Newsom_2008}.
The aberrant neovasculature is believed to be the result of an upregulation of VEGF by RPE cells which stimulates angiogenesis in the CC~\cite{Jager_2008}.
However, the pathogenesis of nAMD remains unclear.
Dysfunctions of the retinal circulations may explain the increased VEGF concentrations, though other mechanisms have been suggested\cite{Ambati_and_Fowler_2012,Pemp_2008,Liu_1995}.
...
The neovasculature may also emerge from the inner retinal circulation and spread towards the outer retina.
Regardless of the location, neovascular membranes are associated with oedema, haemorrhage, scarring and RPE or retinal detachment (when the neurosensory retina separates from the RPE), all of which cause the quick loss of sight observed in nAMD~\cite{Gupta_2015,Jager_2008}.\\

\paragraph*{Retinal tears and breaks}
Tears and breaks (tears through the whole thickness of the neurosensory retina) may occur in the retina for various reasons, including trauma and surgery.
Posterior vitreous detachment is another reason for the appearance of tears and breaks.
...
The combination of these two factors facilitates the accumulation of vitreous fluid in the preretinal space, tearing apart the ILM and the vitreous.
...
In phenomenological models, this relationship is taken to best describe the data, without reference to the processes underlying the observed phenomenon.
Curve fitted models, such a linear regressions, are examples of phenomenological models.
Conversely, mechanistic models the system describing the variables result from assumptions on the biological processes that are thought to be underlying the observed phenomenon.
...
A direct consequence is that parameters in phenomenologial models may be model specific and therefore cannot be used in a different model.
...
Still, systems which span multiple spatial or temporal scales, which often arise in biology, can be challenging to solve within reasonable times.
