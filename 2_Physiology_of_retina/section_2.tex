...
Accumulation of plaque in blood vessels form an obstruction to blood flow which may damage.
In the worst cases, 


\begin{itemize}
\item Retinal vessel occlusion: sickle cell retinopathy and RVO/RVA
\item Glaucoma
\end{itemize}
