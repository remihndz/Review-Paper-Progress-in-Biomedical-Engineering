...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.49\textwidth, height=7cm]{ArchitectureEye} % From Wikipedia retina
  \hfill
  \includegraphics[width=0.49\textwidth, height=7cm]{RetinalLayersFixed}
  \caption{Anatomy of the eye an the retina. (Left) Anatomy of the eye. (Right) The different retinal layers. ILM: inner limiting membrane; NFL: nerve fiber layer; 
    Left: from Wikipedia Eye.\\
    Right: adapted from Trivio et al.~\cite{Trivio_2012}}
